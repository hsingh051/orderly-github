...
return [
    ...
    */
    ...
    // 'api_secret' => env('SHOPIFY_ADMIN_TOKEN', ''),
    ...
    */
    ...
    'api_scopes' => env('SHOPIFY_API_SCOPES', ''),
     ...
     /*
    |--------------------------------------------------------------------------
    | Shopify API Scopes Enterprise Version
    |--------------------------------------------------------------------------
    |
    | This option is for the scopes your application needs in the API.
    |
    */
    ...
    'api_scopes_enterprise' => env('SHOPIFY_API_SCOPES_ENTERPRISE', ''),
    ...
    */
    ...
    'webhooks' => [
            [
                'topic' => env('SHOPIFY_WEBHOOK_0_TOPIC', 'app/uninstalled'),
                'address' => env('SHOPIFY_WEBHOOK_0_ADDRESS', 'https://orderlypay.com/webhook/app-uninstalled')
            ],
            [
                'topic' => env('SHOPIFY_WEBHOOK_1_TOPIC', 'orders/create'),
                'address' => env('SHOPIFY_WEBHOOK_1_ADDRESS', 'https://orderlypay.com/webhook/orders-create')
            ],
            [
                'topic' => env('SHOPIFY_WEBHOOK_2_TOPIC', 'orders/update'),
                'address' => env('SHOPIFY_WEBHOOK_2_ADDRESS', 'https://orderlypay.com/webhook/orders-update')
            ],
            [
                'topic' => env('SHOPIFY_WEBHOOK_3_TOPIC', 'draft_orders/create'),
                'address' => env('SHOPIFY_WEBHOOK_3_ADDRESS', 'https://orderlypay.com/webhook/draft-orders-create')
            ],
            [
                'topic' => env('SHOPIFY_WEBHOOK_4_TOPIC', 'draft_orders/update'),
                'address' => env('SHOPIFY_WEBHOOK_4_ADDRESS', 'https://orderlypay.com/webhook/draft-orders-update')
            ],
    ],
